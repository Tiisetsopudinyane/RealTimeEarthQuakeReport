...
import com.example.soonami.Event;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String USGS_REQUEST_URL =
            "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2020-03-01&endtime=2022-12-01&minmagnitude=5";
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                Log.e(LOG_TAG,"Problem retreiving the requested data",e);
            } finally {
                if (urlConnection != null) {
